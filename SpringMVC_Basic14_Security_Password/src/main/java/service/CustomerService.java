...
//	    필요한 정보  : 로그인한 아이디 , 권한정보(여러개 : ROLE_ADMIN or ROLEUSER ... )
	    
//	    SecurityContext context = SecurityContextHolder.getContext();// Spring Security 전체 정보
//	    Authentication auth = context.getAuthentication(); // Spring Security - 인증 정보
...
//	    
//	    public String noticeReg(Notice n , HttpServletRequest request, Principal principal)
//	    Principal 인터페이스를 정의히면 ... 인증된 상태면 정보를 담은 객체의 주소를 받을 수 있다. 자동으로..
