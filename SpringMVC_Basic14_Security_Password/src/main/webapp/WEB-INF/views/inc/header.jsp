...
<div id="header">
			<div class="top-wrapper">
				...
				<ul id="loginmenu" class="block_hlist">
					...
					<se:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_USER')">	<!-- if문 처럼 사용 -->
				...
				<ul id="membermenu" class="clear">
					<li>
						<a href="${pageContext.request.contextPath}/join/mypage.htm"><img src="${pageContext.request.contextPath}/images/menuMyPage.png" alt="마이페이지" /></a>
					</li>
					<li>
