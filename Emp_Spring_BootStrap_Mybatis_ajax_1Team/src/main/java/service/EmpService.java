...
public class EmpService {
	...
	public List<Emp> getPagedEmpListByLikeEname(String pg, String f,String search) {
		List<Emp> list = null;
		try {
			EmpDao dao = sqlSession.getMapper(EmpDao.class);
			list = dao.getPagedLikeEmpListByEname(Integer.parseInt(pg), Integer.parseInt(f),search);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
